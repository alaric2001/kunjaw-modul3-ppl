...
<div style="margin-top:20px;" class="poppins">
    <div class="" style="margin: 1rem;display: flex;flex-direction: column;gap: 0.5rem;">
        ...
        {{-- @if (session('success'))
            <div style="display: flex;padding: 0.75rem;text-align: center;color: #ffffff;background-color: rgb(51 203 0);border-radius: 4px;height: 34px;justify-content: center;align-items: center;">
                {{ session('success') }}
            </div>
            @endif

            @if (session('error'))
            <div style="display: flex;padding: 0.75rem;text-align: center;color: #ffffff; background-color: #ef4444; border-radius: 4px;height: 34px;justify-content: center;align-items: center;">
                {{ session('error') }}
            </div>
        @endif --}}
        @if (session('success'))
